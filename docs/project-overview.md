...
- 전문 에이전트는 평소 역할별 워크스테이션에 머물고, 팀장 Hermes는 오피스를
  ...
  기록과 David의 다음 행동을 즉시 보여줍니다. 짧은 대화 뒤에도 양쪽 캐릭터가
  각자 담당하는 다음 행동을 안내합니다. 무대는 실제 컨테이너 폭을 관찰해 780px
  ...
  Hermes가 가까운 팀원에게 말을 걸 때 두 말풍선은 좌우 바깥쪽으로 이동하며, 팀원의
  답변은 약 6초 동안 유지되고 중간에 다음 행동 문구로 덮어쓰지 않습니다.
