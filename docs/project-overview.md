...
- 전문 에이전트는 평소 역할별 워크스테이션에 머물고, 팀장 Hermes만 주기적으로
  ...
  리더십 방문이라는 읽을 수 있는 상태 변화입니다. 사무실은 확장된 리서치/면접
  랩, 코드/디자인 스튜디오, Espresso Coffee Club, Quiet Lounge, 협업 테이블,
  Listening Studio와 자료·리뷰 보드로 업무 영역을 구분합니다. 각 방에는 실제
  ...
  핀치로 사무실·가구·캐릭터 전체를 60–140% 확대/축소합니다.
